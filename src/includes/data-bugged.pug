  ...
  const data = [
    ...
    //- account list items
    {
      ...
      array: [
        ...
        'memberships &amp; subscribtions',
        'music library'
      ]
    },
    //- secondary navy links
    {
  ...
  },
  {
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            subMenus: [
              {
                heading: 'international shopping',
                links: [
                  'where we ship',
                  'visit amazon global'
                ]
    ...
    //- hero links & images
    {
      ...
      links: [
        {
          href: 'shipping',
          bgImgPath: './public/images/hero-shipping.webp'
        },
        {
          href: 'Beauty-and-Personal-Care',
          bgImgPath: './public/images/hero-beauty.webp'
        },
        {
          href: 'Computers',
          bgImgPath: './public/images/hero-computers.webp'
        }
      ]
    },
    //- home page cards
  ...
  cards: [
    ...
    },
    {
      ...
      subCards: [
        {
          srchQuery: 'jeans',
          imgSrc: './public/images/fashion-card-jeans.webp',
          name: 'jeans under $50'
        },
        {
          srchQuery: 'tops',
          imgSrc: './public/images/fashion-card-tops.webp',
          name: 'tops under $50'
        },
        {
          srchQuery: 'shoes',
          imgSrc: './public/images/fashion-card-shoes.webp',
          name: 'shoes under $50'
        },
        {
          srchQuery: 'shoes',
    ...
    },
    {
      ...
      subCards: [
        {
          srchQuery: 'dinnerware and accessories',
          imgSrc:'./public/images/refresh-card-dining.webp',
          name:'dining'
        },
        {
          srchQuery:'home',
          imgSrc:'./public/images/home.jpg',
          name: 'home'
        },
        {
          srchQuery:'kitchen',
          imgSrc:'./public/images/kitchen.jpg',
          name: 'kitchen'
        },
        {
          srchQuery:'health and beauty',
          imgSrc:'./public/images/beauty.jpg',
    ...
    },
    {
      ...
      name: "computers & accessories",
      imgsrc:
        "./public/images/computers-card.jpg"
    },
    {
      type: "single",
      srchQuery: "",
    ...
    },
    {
      type: "single",
      srchQuery: "",
      category: "presonal care products",
      name: "health & personal care",
      imgsrc:
        "./public/images/personal-care-card.jpg"
    },
    {
      type: "single",
      srchQuery: "",
    ...
    },
    {
      ...
      imgsrc:
        "./public/images/new-arrival-toys-card.jpg"
    },
